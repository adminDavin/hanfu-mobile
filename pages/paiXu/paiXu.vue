<template>
	<view class="index-wrapper">
		...
		<view style="display: flex;align-items: center;justify-content: space-between;padding: 0 30upx;margin-top: 35upx;margin-bottom: 27upx;">
			<view style="display: flex;align-items: center;">
				<view>价格排序</view>
				<image src="../../static/img/san.png" class="san" style="margin-left: 24upx;"></image>
			</view>
			<view>
				<view>销量排序</view>
			</view>
			<image src="../../static/img/si.png" style="margin-left: 24upx;width: 32upx;height: 32upx;"></image>
			<view style="display: flex;align-items: center;">
				<image src="../../static/img/shai.png" style="width: 32upx;height: 32upx;"></image>
				<view style="margin-left: 24upx;">筛选</view>
			</view>
		</view>
		<view style="background:rgba(245,245,245,1);padding-top: 19upx;box-shadow: rgba(0, 0, 0, 0.08) 7px 0px  0px  0px;">
			<!-- 龙年限定 -->
		...
		<!-- 分类 -->
		<view class="modes" style="width: 100%;height: 100%;position: fixed;top: 0;left: 0;background: rgba(0,0,0,0.5);">
			<view style="width:65%;height: 100%;background: #fff;position: absolute;right: 0;top: 0;">
				<view style="color:#333333;font-size: 30upx;text-align: center;margin-top: 70upx;font-weight: bold;">选择分类</view>
				<view style="padding: 0 25upx 0 21upx; ">
					<view style="display: flex;align-items: center;justify-content: space-between;margin-top: 71upx;">
						<view style="font-size: 25upx;color:#333;font-weight: bold;">分类一</view>
						<image src="../../static/img/xia.png" style="width: 29upx;height: 16upx;"></image>
					</view>
					<view style="display: flex;align-items: center;flex-wrap: wrap;margin-top: 20upx;">
						<view style="background: #f0f0f0;font-size: 21upx;color:#666;padding:13upx 20upx;margin-right: 2%;margin-bottom:20upx;">二级分类</view>
						<view style="background: #f0f0f0;font-size: 21upx;color:#666;padding:13upx 20upx;margin-right: 2%;margin-bottom:20upx;">二级分类</view>
						<view style="background: #f0f0f0;font-size: 21upx;color:#666;padding:13upx 20upx;margin-right: 2%;margin-bottom:20upx;">二级分类</view>
						<view style="background: #f0f0f0;font-size: 21upx;color:#666;padding:13upx 20upx;margin-right: 2%;margin-bottom:20upx;">二级分类</view>
						<view style="background: #f0f0f0;font-size: 21upx;color:#666;padding:13upx 20upx;margin-right: 2%;margin-bottom:20upx;">二级分类</view>
				...
				<view style="padding: 0 25upx 0 21upx; ">
					<view style="display: flex;align-items: center;justify-content: space-between;margin-top: 71upx;">
						<view style="font-size: 25upx;color:#333;font-weight: bold;">分类二</view>
						<image src="../../static/img/xia.png" style="width: 29upx;height: 16upx;"></image>
					</view>
					<view style="display: flex;align-items: center;flex-wrap: wrap;margin-top: 20upx;">
						<view style="background: #f0f0f0;font-size: 21upx;color:#666;padding:13upx 20upx;margin-right: 2%;margin-bottom:20upx;">二级分类</view>
				...
				<view style="display: flex;align-items: center;width: 100%;height: 100upx;position: absolute;bottom: 100upx;width: 100%;">
					<view style="width:50%;background: #F79736;color: #FFF;height: 100upx;display: flex;align-items: center;justify-content: center;">重置</view>
					<view style="width: 50%;background: #F73636;color: #FFF;height: 100upx;display: flex;align-items: center;justify-content: center;">确定</view>
				</view>
			</view>
