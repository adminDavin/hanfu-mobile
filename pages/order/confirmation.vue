		...
		<view class="addr" @tap="selectAddress">
			<view style="display: flex;align-items: center;justify-content: space-between;">
				<view class="right" style="width: 70%;">
					...
					<view class="addres" style="margin-top: 10upx;">
						{{recinfo.address.region.label}}
						{{recinfo.address.detailed}}
					</view>
				</view>
				<image src="../../static/img/youjian.png" style="width: 12upx;height: 20upx;"></image>
			</view>
			...
			<view class="row" v-for="(row,index) in buylist" :key="index">
				<view class="goods-info">
					...
					<view class="info">
						...
						<view class="spec">已选规格：{{row.spec}}选择 </view>
						<view class="price-number">
							<view class="price">￥{{row.price*row.number}}</view>
							<view class="number " style="color: #999999;font-size: 20upx;">
								数量:{{row.number}}
							</view>
						</view>
					</view>
