...
var x5=_mz(z,'view',['bindtap',4,'class',1,'data-event-opts',2],[],e2,t1,gg)
var o6=_v()
_(x5,o6)
if(_oz(z,7,e2,t1,gg)){o6.wxVkey=1
}
o6.wxXCkey=1
_(b3,x5)
return b3
...
var z=gz$gwx_9()
var c8=_mz(z,'mpvue-city-picker',['bind:__l',0,'bind:onConfirm',1,'class',1,'data-event-opts',2,'data-ref',3,'pickerValueDefault',4,'themeColor',5,'vueId',6],[],e,s,gg)
_(r,c8)
return r
}
...
var hMB=_mz(z,'m-store-pro',['bind:__l',9,'bind:touchOnGoods',1,'data-event-opts',2,'rowData',3,'vueId',4],[],oJB,xIB,gg)
_(fKB,hMB)
return fKB
}
bGB.wxXCkey=4
_2z(z,7,oHB,aDB,lCB,gg,bGB,'box','i','i')
return tEB
}
cAB.wxXCkey=4
_2z(z,3,oBB,e,s,gg,cAB,'category','index','id')
var oNB=_mz(z,'m-footer-car',['bind:__l',14,'bind:handleFn',1,'data-event-opts',2,'num',3,'price',4,'vueId',5],[],e,s,gg)
_(o0,oNB)
var cOB=_mz(z,'view',['bindtap',20,'catchtouchmove',1,'class',2,'data-event-opts',3],[],e,s,gg)
var oPB=_mz(z,'view',['catchtap',24,'class',1,'data-event-opts',2],[],e,s,gg)
var lQB=_v()
_(oPB,lQB)
var aRB=function(eTB,tSB,bUB,gg){
var xWB=_mz(z,'uni-number-box',['bind:__l',31,'bind:change',1,'data-event-opts',2,'max',3,'min',4,'rowData',5,'vueId',6],[],eTB,tSB,gg)
_(bUB,xWB)
return bUB
}
lQB.wxXCkey=4
_2z(z,29,aRB,e,s,gg,lQB,'item','index','index')
var oXB=_mz(z,'m-footer-car',['bind:__l',38,'bind:handleFn',1,'data-event-opts',2,'num',3,'price',4,'vueId',5],[],e,s,gg)
_(oPB,oXB)
_(cOB,oPB)
_(o0,cOB)
_(r,o0)
...
var a6B=_mz(z,'goods-list',['bind:__l',3,'class',1,'goodsList',2,'vueId',3],[],e,s,gg)
_(l5B,a6B)
var t7B=_mz(z,'goods-list',['bind:__l',7,'class',1,'goodsList',2,'vueId',3],[],e,s,gg)
_(l5B,t7B)
var e8B=_mz(z,'goods-list',['bind:__l',11,'class',1,'goodsList',2,'vueId',3],[],e,s,gg)
_(l5B,e8B)
_(o4B,l5B)
var b9B=_mz(z,'uni-load-more',['bind:__l',15,'class',1,'status',2,'vueId',3],[],e,s,gg)
_(o4B,b9B)
_(r,o4B)
return r
}
...
var lIC=_mz(z,'my-issue',['bind:__l',1,'vueId',1],[],e,s,gg)
_(oHC,lIC)
var aJC=_mz(z,'my-issue',['bind:__l',3,'score',1,'vueId',2],[],e,s,gg)
_(oHC,aJC)
var tKC=_mz(z,'my-issue',['bind:__l',6,'starsDisabled',1,'vueId',2],[],e,s,gg)
_(oHC,tKC)
_(r,oHC)
return r
}
...
var z=gz$gwx_24()
var xOC=_mz(z,'zy-search',['bind:__l',0,'isBlock',1,'isFocus',1,'showWant',2,'vueId',3],[],e,s,gg)
_(r,xOC)
return r
}
...
var c9C=_mz(z,'view',['bindtap',4,'class',1,'data-event-opts',2,'style',3],[],c6C,f5C,gg)
var o0C=_mz(z,'uni-icons',['bind:__l',8,'color',1,'size',2,'type',3,'vueId',4],[],c6C,f5C,gg)
_(c9C,o0C)
var lAD=_mz(z,'uni-icons',['bind:__l',13,'color',1,'size',2,'type',3,'vueId',4],[],c6C,f5C,gg)
_(c9C,lAD)
_(h7C,c9C)
return h7C
}
x3C.wxXCkey=4
_2z(z,2,o4C,e,s,gg,x3C,'star','index','index')
var aBD=_v()
_(o2C,aBD)
var tCD=function(bED,eDD,oFD,gg){
var oHD=_mz(z,'view',['bindtap',22,'class',1,'data-event-opts',2,'style',3],[],bED,eDD,gg)
var fID=_mz(z,'uni-icons',['bind:__l',26,'color',1,'size',2,'type',3,'vueId',4],[],bED,eDD,gg)
_(oHD,fID)
var cJD=_mz(z,'uni-icons',['bind:__l',31,'color',1,'size',2,'type',3,'vueId',4],[],bED,eDD,gg)
_(oHD,cJD)
_(oFD,oHD)
return oFD
}
aBD.wxXCkey=4
_2z(z,20,tCD,e,s,gg,aBD,'star','index','index')
_(r,o2C)
return r
}
...
var oZD=_v()
_(xUD,oZD)
if(_oz(z,11,eRD,tQD,gg)){oZD.wxVkey=1
}
var c1D=_v()
_(xUD,c1D)
if(_oz(z,12,eRD,tQD,gg)){c1D.wxVkey=1
}
var o2D=_v()
_(xUD,o2D)
if(_oz(z,13,eRD,tQD,gg)){o2D.wxVkey=1
}
oVD.wxXCkey=1
fWD.wxXCkey=1
cXD.wxXCkey=1
...
lOD.wxXCkey=2
_2z(z,4,aPD,e,s,gg,lOD,'row','index','index')
oND.wxXCkey=1
_(r,cMD)
return r
}
...
__wxAppCode__['pages/address/addressManage.json']={"usingComponents":{"mpvue-city-picker":"/pages/mpvue-citypicker/mpvueCityPicker"}};
...
(function (e) {
  function t(t) {
    for (var o, r, i = t[0], c = t[1], a = t[2], m = 0, p = []; m < i.length; m++) {
      r = i[m], u[r] && p.push(u[r][0]), u[r] = 0;
    }
  ...
  c.e = function (e) {
    ...
    r[e] ? t.push(r[e]) : 0 !== r[e] && n[e] && t.push(r[e] = new Promise(function (t, n) {
      ...
      }[e] || e) + ".wxss", u = c.p + o, s = document.getElementsByTagName("link"), i = 0; i < s.length; i++) {
        var a = s[i],
            m = a.getAttribute("data-href") || a.getAttribute("href");
        if ("stylesheet" === a.rel && (m === o || m === u)) return t();
      }
    ...
    if (0 !== o) if (o) t.push(o[2]);else {
      ...
      m.charset = "utf-8", m.timeout = 120, c.nc && m.setAttribute("nonce", c.nc), m.src = i(e), a = function a(t) {
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push([["components/goodsList/goodslist"], {
  ...
  "922c": function c(t, n, u) {},
  "9d54": function d54(t, n, u) {
    "use strict";
  ...
  b69d: function b69d(t, n, u) {
    ...
    u("69f9");
    var a = u("2877"),
        c = Object(a["a"])(o["default"], e["a"], e["b"], !1, null, "0462819b", null);
    n["default"] = c.exports;
  }
}]);
;
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push([["components/zy-search/zy-search"], {
  ...
  ab47: function ab47(t, e, a) {},
  eb90: function eb90(t, e, a) {
    "use strict";
    ...
    a("0bb5");
    var o = a("2877"),
        s = Object(o["a"])(r["default"], n["a"], n["b"], !1, null, "679531e2", null);
    e["default"] = s.exports;
  }
}]);
;
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/home"],{"27c6":function(t,i,o){},"444d":function(t,i,o){"use strict";o.r(i);var e=o("a033"),n=o.n(e);for(var a in e)"default"!==a&&function(t){o.d(i,t,function(){return e[t]})}(a);i["default"]=n.a},a033:function(t,i,o){"use strict";(function(t,e){Object.defineProperty(i,"__esModule",{value:!0}),i.default=void 0;var n=a(o("102a"));function a(t){return t&&t.__esModule?t:{default:t}}var g=function(){return o.e("components/goodsList/goodslist").then(o.bind(null,"b69d"))},s=function(){return o.e("components/uni-load-more/uni-load-more").then(o.bind(null,"ad5c"))},c={components:{goodsList:g,uniLoadMore:s},data:function(){return{statusHeight:20,current:0,mode:"round",swiperList:[{id:1,src:"url1",img:"/static/img/1.jpg"},{id:2,src:"url2",img:"/static/img/2.jpg"},{id:3,src:"url3",img:"/static/img/3.jpg"}],currentSwiper:0,categoryList:[{id:1,name:"办公",img:"/static/img/category/1.png"},{id:2,name:"家电",img:"/static/img/category/2.png"},{id:3,name:"服饰",img:"/static/img/category/3.png"},{id:4,name:"日用",img:"/static/img/category/4.png"},{id:5,name:"蔬果",img:"/static/img/category/5.png"},{id:6,name:"运动",img:"/static/img/category/6.png"},{id:7,name:"书籍",img:"/static/img/category/7.png"},{id:8,name:"文具",img:"/static/img/category/8.png"}],Promotion:[],goodsList:[{goods_id:0,img:"/static/img/goods/p1.jpg",name:"商品名称",price:168,slogan:1558},{goods_id:1,img:"/static/img/goods/p2.jpg",name:"商品名称商品名",price:167,slogan:1038},{goods_id:2,img:"/static/img/goods/p3.jpg",name:"商品名称商品名称商品名称商品名称商品名称",price:17,slogan:1228},{goods_id:3,img:"/static/img/goods/p4.jpg",name:"商品名称商品名称商",price:167,slogan:1058},{goods_id:4,img:"/static/img/goods/p5.jpg",name:"商品名称商品名称商品名",price:107,slogan:558},{goods_id:5,img:"/static/img/goods/p6.jpg",name:"商品名名称商品品名称商品名称",price:177,slogan:58},{goods_id:6,img:"/static/img/goods/p7.jpg",name:"商品名称商品名称商品名称商商品名称",price:18,slogan:1800},{goods_id:7,img:"/static/img/goods/p8.jpg",name:"商品名称商品名称商品名称商商品名称商品名称商品名称商品名",price:144,slogan:13526},{goods_id:8,img:"/static/img/goods/p9.jpg",name:"商品名称商品名称商品名称商品名称商品名称",price:123,slogan:1e3},{goods_id:9,img:"/static/img/goods/p10.jpg",name:"商品名称商品名称商品名称商品名",price:186,slogan:3008}],goods:[{goods_id:0,img:"/static/img/goods/p1.jpg",name:"商品名称",price:168,slogan:1558},{goods_id:1,img:"/static/img/goods/p2.jpg",name:"商品名称商品名",price:167,slogan:1038}],status:"loading"}},onLoad:function(){this.loadPromotion()},onPullDownRefresh:function(){console.log(t("下拉了"," at pages\\index\\home.vue:234"))},onReachBottom:function(){this.goodsList=this.goodsList.concat(this.goodsList)},mounted:function(){var i=this;console.log(t(n.default.url," at pages\\index\\home.vue:240")),e.getLocation({geocode:!0,success:function(t){i.city=t.address.city},fail:function(t){}}),e.getSystemInfo({success:function(o){i.statusHeight=o.statusBarHeight,console.log(t(o," at pages\\index\\home.vue:253"))}})},methods:{tosearch:function(){e.navigateTo({url:"../search/search"})},changeSwiper:function(t){this.currentSwiper=t.detail.current},loadPromotion:function(){for(var t=new Date,i=t.getFullYear(),o=t.getMonth()+1,e=t.getDate(),n=i+"/"+o+"/"+e+" 23:59:59",a=[{title:"整点秒杀",ad:"整天秒杀专区",img:"/static/img/s1.jpg",countdown:!1},{title:"限时抢购",ad:"每天23点上线",img:"/static/img/s2.jpg",countdown:n}],g=0;g<a.length;g++){var s=a[g];if(s.countdown){var c="00",d="00",r="00",u=new Date,m=new Date(n);if(!(u>=m)){var l=parseInt((m.getTime()-u.getTime())/1e3);c=parseInt(l/3600),d=parseInt(l%3600/60),r=l%60,c=c<10?"0"+c:c,d=d<10?"0"+d:d,r=r<10?"0"+r:r}a[g].countdown={h:c,m:d,s:r}}}this.Promotion=a}}};i.default=c}).call(this,o("0de9")["default"],o("6e42")["default"])},a66f:function(t,i,o){"use strict";o.r(i);var e=o("ae0e"),n=o("444d");for(var a in n)"default"!==a&&function(t){o.d(i,t,function(){return n[t]})}(a);o("c32e");var g=o("2877"),s=Object(g["a"])(n["default"],e["a"],e["b"],!1,null,"2212a570",null);i["default"]=s.exports},ae0e:function(t,i,o){"use strict";var e=function(){var t=this,i=t.$createElement;t._self._c},n=[];o.d(i,"a",function(){return e}),o.d(i,"b",function(){return n})},b3c6:function(t,i,o){"use strict";(function(t){o("22dd"),o("921b");e(o("66fd"));var i=e(o("a66f"));function e(t){return t&&t.__esModule?t:{default:t}}t(i.default)}).call(this,o("6e42")["createPage"])},c32e:function(t,i,o){"use strict";var e=o("27c6"),n=o.n(e);n.a}},[["b3c6","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/product/product"],{"073d":function(t,o,e){},"176a":function(t,o,e){"use strict";var a=function(){var t=this,o=t.$createElement;t._self._c},n=[];e.d(o,"a",function(){return a}),e.d(o,"b",function(){return n})},"18e5":function(t,o,e){"use strict";(function(t){e("22dd"),e("921b");a(e("66fd"));var o=a(e("a859"));function a(t){return t&&t.__esModule?t:{default:t}}t(o.default)}).call(this,e("6e42")["createPage"])},"7cb4":function(t,o,e){"use strict";e.r(o);var a=e("aa7f"),n=e.n(a);for(var i in a)"default"!==i&&function(t){e.d(o,t,function(){return a[t]})}(i);o["default"]=n.a},a859:function(t,o,e){"use strict";e.r(o);var a=e("176a"),n=e("7cb4");for(var i in n)"default"!==i&&function(t){e.d(o,t,function(){return n[t]})}(i);e("e5ad");var s=e("2877"),r=Object(s["a"])(n["default"],a["a"],a["b"],!1,null,"5367fd78",null);o["default"]=r.exports},aa7f:function(t,o,e){"use strict";(function(t,a){Object.defineProperty(o,"__esModule",{value:!0}),o.default=void 0;var n=i(e("102a"));function i(t){return t&&t.__esModule?t:{default:t}}var s=function(){return e.e("components/goodsList/goodslist").then(e.bind(null,"b69d"))},r=function(){return e.e("components/uni-load-more/uni-load-more").then(e.bind(null,"ad5c"))},d={components:{goodsList:s,uniLoadMore:r},data:function(){return{datapay:"",orderId:"",statusHeight:20,current:0,mode:"round",swiperList:[{id:1,src:"url1",img:"/static/img/1.jpg"},{id:2,src:"url2",img:"/static/img/2.jpg"},{id:3,src:"url3",img:"/static/img/3.jpg"}],currentSwiper:0,categoryList:[{id:1,name:"办公",img:"/static/img/category/1.png"},{id:2,name:"家电",img:"/static/img/category/2.png"}],Promotion:[],goodsList:[{goods_id:7,img:"/static/img/goods/p8.jpg",name:"商品名称商品名称商品名称商商品名称商品名称商品名称商品名",price:144,slogan:13526},{goods_id:8,img:"/static/img/goods/p9.jpg",name:"商品名称商品名称商品名称商品名称商品名称",price:123,slogan:1e3},{goods_id:9,img:"/static/img/goods/p10.jpg",name:"商品名称商品名称商品名称商品名",price:186,slogan:3008}],goods:[{goods_id:0,img:"/static/img/goods/p1.jpg",name:"商品名称",price:168,slogan:1558},{goods_id:1,img:"/static/img/goods/p2.jpg",name:"商品名称商品名",price:167,slogan:1038}],status:"loading"}},onLoad:function(){this.loadPromotion()},onPullDownRefresh:function(){console.log(t("下拉了"," at pages\\product\\product.vue:301"))},onReachBottom:function(){this.goodsList=this.goodsList.concat(this.goodsList)},mounted:function(){var o=this;a.getLocation({geocode:!0,success:function(t){o.city=t.address.city},fail:function(t){}}),a.getSystemInfo({success:function(e){o.statusHeight=e.statusBarHeight,console.log(t(e," at pages\\product\\product.vue:319"))}})},methods:{buy:function(){var o=this;a.request({url:n.default.url+"order/creat",method:"get",dataType:"JSON",data:{userId:1,userAddressId:1,googsId:3,logisticsOrderName:1,respId:3,logisticsOrdersId:1,logisticsCompany:1,hfDesc:1,id:54,orderDetailStatus:1,hfTax:1,purchasePrice:1,purchaseQuantity:1,distribution:1,payStatus:1,orderType:1,amount:1,hfMemo:1,hfRemark:1,payMethodName:1,ordersid:57,payMethodType:1},success:function(e){console.log(t("提交订单1",e," at pages\\product\\product.vue:378")),o.orderId=e.data.data[0].ordersId,console.log(t(o.orderId," at pages\\product\\product.vue:380")),200==e.statusCode&&a.request({url:n.default.urlPay+"payment/pay",method:"get",dataType:"JSON",data:{orderId:o.orderId,bossId:1,Amount:1},success:function(e){console.log(t("提交订单2",e," at pages\\product\\product.vue:392")),o.datapay=e.data.data,console.log(t(o.datapay," at pages\\product\\product.vue:400")),a.requestPayment({provider:"alipay",orderInfo:o.datapay,success:function(o){console.log(t("success:"+JSON.stringify(o)," at pages\\product\\product.vue:405"))},fail:function(o){console.log(t("fail:"+JSON.stringify(o)," at pages\\product\\product.vue:408"))}})}})}})},tosearch:function(){a.navigateTo({url:"../search/search"})},changeSwiper:function(t){this.currentSwiper=t.detail.current},loadPromotion:function(){for(var t=new Date,o=t.getFullYear(),e=t.getMonth()+1,a=t.getDate(),n=o+"/"+e+"/"+a+" 23:59:59",i=[{title:"整点秒杀",ad:"整天秒杀专区",img:"/static/img/s1.jpg",countdown:!1},{title:"限时抢购",ad:"每天23点上线",img:"/static/img/s2.jpg",countdown:n}],s=0;s<i.length;s++){var r=i[s];if(r.countdown){var d="00",u="00",c="00",g=new Date,l=new Date(n);if(!(g>=l)){var p=parseInt((l.getTime()-g.getTime())/1e3);d=parseInt(p/3600),u=parseInt(p%3600/60),c=p%60,d=d<10?"0"+d:d,u=u<10?"0"+u:u,c=c<10?"0"+c:c}i[s].countdown={h:d,m:u,s:c}}}this.Promotion=i}}};o.default=d}).call(this,e("0de9")["default"],e("6e42")["default"])},e5ad:function(t,o,e){"use strict";var a=e("073d"),n=e.n(a);n.a}},[["18e5","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/address/address"],{"5a15":function(e,s,a){"use strict";var t=a("b627"),n=a.n(t);n.a},"745c":function(e,s,a){"use strict";(function(e,t){Object.defineProperty(s,"__esModule",{value:!0}),s.default=void 0;var n=r(a("97ed")),d=r(a("ec04"));function r(e){return e&&e.__esModule?e:{default:e}}var o=new n.default,u={data:function(){return{source:0,AddressList:[],addressList:[{name:"刘晓晓",mobile:"18666666666",addressName:"贵族皇仕牛排(东城店)",address:"北京市东城区",area:"B区",default:!0},{name:"刘大大",mobile:"18667766666",addressName:"龙回1区12号楼",address:"山东省济南市历城区",area:"西单元302",default:!1}]}},onLoad:function(s){console.log(e(s.source," at pages\\address\\address.vue:53"));s.source;var a=this;s.source&&(a.source=s.source)},onShow:function(){this.load()},methods:{load:function(){var s=this;o.submit({request:{addressList:["USERADDRESSSELFLIST"]},callback:function(a){var n=d.default.checkError(a,["addressList"],function(e,s){t.showToast({title:s,icon:"none"})});console.log(e(n," at pages\\address\\address.vue:84")),n.addressList&&(s.AddressList=n.addressList)},error:function(e){t.showToast({title:"出错啦",icon:"none"})}})},checkAddress:function(s){var a=this;1==a.source?(console.log(e(s," at pages\\address\\address.vue:112")),t.redirectTo({url:"../order/createOrder?addressId="+s})):2==a.source?(console.log(e("13123",s," at pages\\address\\address.vue:118")),t.setStorage({key:"nearByBusinessAddressID",data:s,success:function(){console.log(e("跳转"," at pages\\address\\address.vue:123")),t.switchTab({url:"../nearbyBusiness/nearbyBusiness"})}})):3==a.source&&t.setStorage({key:"nearByBusinessAddressID",data:s,success:function(){console.log(e("跳转"," at pages\\address\\address.vue:135")),t.navigateBack()}})},del:function(s){var a=this;t.showModal({title:"提示",content:"是否删除地址信息",success:function(n){n.confirm?o.submit({request:{address:["USERADDRESSSELFREMOVE",[{id:s}]]},callback:function(s){var n=d.default.checkError(s,["address"],function(e,s){t.showToast({title:s,icon:"none"})});console.log(e(n," at pages\\address\\address.vue:161")),n.address&&t.showToast({title:"删除成功",success:function(){setTimeout(function(){a.load()},1e3)}})},error:function(e){t.showToast({title:"出错啦",icon:"none"})}}):n.cancel&&console.log(e("用户点击取消"," at pages\\address\\address.vue:182"))}})},addAddress:function(e,s){t.navigateTo({url:"./addressManage"})},refreshList:function(s,a){this.addressList.unshift(s),console.log(e(s,a," at pages\\address\\address.vue:198"))}}};s.default=u}).call(this,a("0de9")["default"],a("6e42")["default"])},"77c3":function(e,s,a){"use strict";var t=function(){var e=this,s=e.$createElement;e._self._c},n=[];a.d(s,"a",function(){return t}),a.d(s,"b",function(){return n})},adfc:function(e,s,a){"use strict";(function(e){a("22dd"),a("921b");t(a("66fd"));var s=t(a("e1e3"));function t(e){return e&&e.__esModule?e:{default:e}}e(s.default)}).call(this,a("6e42")["createPage"])},b627:function(e,s,a){},e1e3:function(e,s,a){"use strict";a.r(s);var t=a("77c3"),n=a("f623");for(var d in n)"default"!==d&&function(e){a.d(s,e,function(){return n[e]})}(d);a("5a15");var r=a("2877"),o=Object(r["a"])(n["default"],t["a"],t["b"],!1,null,null,null);s["default"]=o.exports},f623:function(e,s,a){"use strict";a.r(s);var t=a("745c"),n=a.n(t);for(var d in t)"default"!==d&&function(e){a.d(s,e,function(){return t[e]})}(d);s["default"]=n.a}},[["adfc","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/address/addressManage"],{"15d1":function(e,s,a){"use strict";a.r(s);var t=a("d18f"),d=a.n(t);for(var i in t)"default"!==i&&function(e){a.d(s,e,function(){return t[e]})}(i);s["default"]=d.a},"1c0c":function(e,s,a){},"462b":function(e,s,a){"use strict";a.r(s);var t=a("5615"),d=a("15d1");for(var i in d)"default"!==i&&function(e){a.d(s,e,function(){return d[e]})}(i);a("f0c5");var n=a("2877"),r=Object(n["a"])(d["default"],t["a"],t["b"],!1,null,null,null);s["default"]=r.exports},5615:function(e,s,a){"use strict";var t=function(){var e=this,s=e.$createElement;e._self._c},d=[];a.d(s,"a",function(){return t}),a.d(s,"b",function(){return d})},"729b":function(e,s,a){"use strict";(function(e){a("22dd"),a("921b");t(a("66fd"));var s=t(a("462b"));function t(e){return e&&e.__esModule?e:{default:e}}e(s.default)}).call(this,a("6e42")["createPage"])},d18f:function(e,s,a){"use strict";(function(e,t){Object.defineProperty(s,"__esModule",{value:!0}),s.default=void 0;var d=r(a("97ed")),i=r(a("ec04")),n=r(a("102a"));function r(e){return e&&e.__esModule?e:{default:e}}var o=function(){return Promise.all([a.e("common/vendor"),a.e("pages/mpvue-citypicker/mpvueCityPicker")]).then(a.bind(null,"cbb8"))},u=new d.default,c={data:function(){return{consignee:"",phone:"",addressId:"",province:"",details:"",addressList:[],direction:"",cityPickerValueDefault:[0,0,1],themeColor:"#007AFF",pickerText:"选择省/市/区",Default:!1}},components:{mpvueCityPicker:o},onLoad:function(s){var a="新增收货地址";if("edit"===s.type){a="编辑收货地址",this.addressId=JSON.parse(s.data),console.log(e(this.addressId," at pages\\address\\addressManage.vue:69"));var d=this;d.addressId&&u.submit({request:{s:["USERADDRESSSELFGET",[{id:d.addressId}]]},callback:function(s){var a=i.default.checkError(s,"s",function(e,s){t.showToast({title:s,icon:"none"})});console.log(e(a," at pages\\address\\addressManage.vue:83")),d.addressList=a.s;var n=a.s.province,r=a.s.city,o=a.s.district;d.pickerText=n+"-"+r+"-"+o,1==d.addressList.default?d.Default=!0:d.Default=!1},error:function(e){i.default.err("err",e,1)}})}this.manageType=s.type,t.setNavigationBarTitle({title:a})},methods:{switchChange:function(s){this.addressList.default=s.detail,1==s.detail.value?this.addressList.default=1:this.addressList.default=0,console.log(e(s.detail," at pages\\address\\addressManage.vue:114"))},showMulLinkageThreePicker:function(){console.log(e(this.showMulLinkageThreePicker," at pages\\address\\addressManage.vue:118")),this.$refs.mpvueCityPicker.show()},onConfirm:function(s){console.log(e(s," at pages\\address\\addressManage.vue:122"));var a=s.label;this.pickerText=a;var t=a.split("-");this.addressList.province=t[0],this.addressList.city=t[1],this.addressList.district=t[2]},chooseLocation:function(){var s=this;t.chooseLocation({success:function(a){s.direction=a.name,console.log(e("位置名称："+a.name," at pages\\address\\addressManage.vue:136")),console.log(e("详细地址："+a.address," at pages\\address\\addressManage.vue:137")),console.log(e("纬度："+a.latitude," at pages\\address\\addressManage.vue:138")),console.log(e("经度："+a.longitude," at pages\\address\\addressManage.vue:139")),s.addressList.longitude=a.longitude,s.addressList.latitude=a.latitude}})},submit:function(){t.request({url:n.default.urlAdress+"user/address/addAddress",method:"get",dataType:"JSON",data:{UserId:"1",Contact:"15022209253",HfConty:"中国",HfAddressDetail:"西青区",HfCity:"1",HfDesc:"11111",HfProvince:1,IsFaultAddress:"1"},success:function(s){console.log(e("添加收获地址",s," at pages\\address\\addressManage.vue:173"))}})},confirm:function(){var e=this.addressData;e.name?/(^1[3|4|5|7|8][0-9]{9}$)/.test(e.mobile)?e.address?e.area?(this.$api.prePage().refreshList(e,this.manageType),this.$api.msg("地址".concat("edit"==this.manageType?"修改":"添加","成功")),setTimeout(function(){t.navigateBack()},800)):this.$api.msg("请填写门牌号信息"):this.$api.msg("请在地图选择所在位置"):this.$api.msg("请输入正确的手机号码"):this.$api.msg("请填写收货人姓名")}}};s.default=c}).call(this,a("0de9")["default"],a("6e42")["default"])},f0c5:function(e,s,a){"use strict";var t=a("1c0c"),d=a.n(t);d.a}},[["729b","common/runtime","common/vendor"]]]);
});
